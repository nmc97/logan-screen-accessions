...
def fetch_and_convert(input_file, output_file):
    ...
    with open(output_file, 'w', newline='') as csvfile:
        ...
        # Write the header
        header = [
            'sra_accession', 'Accession', 'Title', 'Organism', 'Taxonomy ID', 'Owner', 'Owner URL', 'Contact First Name', 'Contact Last Name',
        ...
        for sra_accession in sra_accessions:
            ...
            for biosample in root.findall('.//BioSample'):
                ...
                csvwriter.writerow([
                    sra_accession, accession, title, organism, taxonomy_id, owner, owner_url, contact_first_name, contact_last_name,
